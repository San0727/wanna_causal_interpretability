from data_directional import list_datasets
from das_directional import experiment
import argparse
...
def main(
    ...
    manipulate: str=False, datasets: str=None, direction: str=None):
    ...
    for dataset in datasets[start:end]:
        run_command(tokenizer, gpt, model, dataset, lr, only_das, hparam_non_das, das_label, revision, folder, manipulate, direction)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--direction", type=str, default=None,
                        help="None: bidirectional (default), 'wantto_to_wanna': types[0]=base, 'wanna_to_wantto': types[1]=base")
